...
1. [Terraform](https://pragmacoders.com/blog/creating-an-ec2-instance-with-terraform)
...
1. [KubeADM on AWS](https://www.cloudtechnologyexperts.com/kubeadm-on-aws/) (outdated; dashboard is not working. See README.md under '<root>/src' to make it work)
2. [KOPS on AWS](https://www.patricia-anong.com/blog/2018/8/kubernetes-in-aws-using-kops)
...
Dashboarding: [Kubernetes Dashbaord](https://github.com/kubernetes/dashboard)

Steps:

1. enable tcp port 8443 in AWS or any other provider
2. create new pods via installation commands, found in latest version from [Kubernetes Dashbaord](https://github.com/kubernetes/dashboard/releases)
